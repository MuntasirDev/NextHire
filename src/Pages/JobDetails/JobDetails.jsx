    ...
    return (
      <div className="text-center py-20 text-xl text-red-600">
        ...
        <p className="text-gray-500 text-base mt-2">
          Please check the job ID and API endpoint.
        </p>
      </div>
    );
  }
          ...
          <div className="lg:col-span-2 space-y-8">
            <div className="bg-white p-6 md:p-8 rounded-xl shadow-md border-l-4 border-indigo-400">
              <h2 className="text-2xl font-bold text-gray-800 mb-4 flex items-center">
                <FaClipboardList className="mr-3 text-indigo-600" /> Job
                Description
              </h2>
            ...
            <div className="bg-white p-6 md:p-8 rounded-xl shadow-md border-l-4 border-indigo-400">
              <h2 className="text-2xl font-bold text-gray-800 mb-4 flex items-center">
                <FaTasks className="mr-3 text-indigo-600" /> Key
                Responsibilities
              </h2>
            ...
            <div className="bg-white p-6 md:p-8 rounded-xl shadow-md border-l-4 border-indigo-400">
              <h2 className="text-2xl font-bold text-gray-800 mb-4 flex items-center">
                <FaClipboardList className="mr-3 text-indigo-600" /> Required
              ...
              <div className="flex flex-wrap gap-3">
                {requirements &&
                  requirements.map((req, index) => (
                    <span
                      key={index}
                      className="px-4 py-2 bg-indigo-100 text-indigo-700 rounded-full font-semibold text-sm shadow-sm"
                    >
                      {req}
                    </span>
                  ))}
